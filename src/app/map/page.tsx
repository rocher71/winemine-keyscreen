            ...
            return (
              <button
                ...
                style={{
                  padding: '6px 12px',
                  borderRadius: 999,
                  background: on ? 'rgba(201,168,76,0.18)' : 'var(--color-glass-bg)',
                  border: `1px solid ${on ? '#C9A84C' : 'var(--color-glass-border)'}`,
        ...
        {notes.length > 0 && (
          <button
            ...
            style={{
              ...
              padding: '8px 12px',
              borderRadius: 999,
              background: 'linear-gradient(135deg, var(--color-wine-red), var(--color-gold))',
